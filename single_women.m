function EMAX_W_T_OUT = single_women(WS, t, EMAX_W_T, EMAX_H_T, DRAW_B, TERMINAL, husbands_2, husbands_3, husbands_4, husbands_5)
global exp_vector;
global normal_arr;
global sigma;
global G_epsilon_b;
                    ...
                    for draw_b = 1 : DRAW_B
                        ...
                        if (CHOOSE_HUSBAND == 1)
                           [wage_h,JOB_OFFER_H] = calculate_wage(H, H_HSD, H_HSG, H_SC, H_CG, H_PC, HE, HSD, HSG, SC, CG, PC, WE,...
                                0, G_epsilon_b(draw_b, t, WS, 1), prev_state_w, ability_w, ability_h,t);
                        end
                        %%%%%%%%%%%%%%%%%%%%%%%%   JOB OFFER PROBABILITY + WAGE WIFE     %%%%%%%%%%%%%%%%
                        [wage_w, JOB_OFFER_W] = calculate_wage(W, H_HSD, H_HSG, H_SC, H_CG, H_PC, HE, HSD, HSG, SC, CG, PC, WE,...
                               G_w_draws(draw_b, t, WS, 1), G_epsilon_b(draw_b, t, WS, 2), prev_state_w, ability_w, ability_h,t);
                        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
