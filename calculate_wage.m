function [wage, JOB_OFFER] = calculate_wage(sex, H_HSD, H_HSG,H_SC, H_CG, H_PC, HE, HSD, HSG, SC, CG, PC, WE , h_draws, w_draws, draw_f, t, school_group, prev_state_w, prev_state_h)
...
global row_h    ;global row0_h   ;global row11_h  ;global row12_h  ;global row13_h  ;global row14_h ;global row2_h   ;
if (sex == 0)   % H=0
    ...
    if PROB_H > h_draws(draw_f,t,school_group,6)
        ...
        tmp2_h = (epsilon_f(draw_f, t,school_group,1)*sigma(1,1)); %epsilon_f(draw_f, t, sex)
    ...
    if PROB_W > w_draws(draw_f,t,school_group,1)
        ...
        tmp2_w = (epsilon_f(draw_f, t, school_group,2)*sigma(2,2)); %epsilon_f(draw_f, t, sex)  
