...
// time | w exp | kids  | work  | w ability | h ability | h school | w school | match q | bp    |
// 0-27 | 0 - 4 | 0 - 3 | 0 - 1 | 0 - 2     | 0 - 2     | 0 - 4    | 0 - 4    | 0 - 2   | 0 - 7 |
using MarriedEmax = boost::multi_array<double, 10>;
